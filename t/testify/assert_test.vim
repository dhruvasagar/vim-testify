...
call testify#it('assert equals should succeed when arguments are equal',
...
call testify#it('assert equals should raise exception when arguments are not equal',
...
call testify#it('assert not_equals should succeed when arguments are not equal',
...
call testify#it('assert not_equals should raise exception when arguments are equal',
...
call testify#it('assert matches should not raise exception when arguments match',
...
call testify#it('assert matches should raise exception when arguments do not match',
...
call testify#it('assert not_matches should not raise exception when arguments do not match',
...
call testify#it('assert not_matches should raise exception when arguments match',
...
call testify#it('assert empty should not raise exception when argument is empty',
...
call testify#it('assert empty should raise exception when arguments match',
...
call testify#it('assert not_empty should not raise exception when arguments is not empty',
      \ function('s:TestifyEmptyFailure'))
