# VIM Testify v0.6.0 [![Build](https://github.com/dhruvasagar/vim-testify/actions/workflows/ci.yml/badge.svg)](https://github.com/dhruvasagar/vim-testify/actions/workflows/ci.yml)
